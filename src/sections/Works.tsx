        ...
        <ul className="flex flex-col gap-7 w-full px-4">
          {projects.map((project) => (
            <FadeInDiv key={project.title}>
              <li className="flex items-center justify-around w-full h-fit">
                <div className="relative min-w-[176px] w-44 h-44 rounded-full shadow-md overflow-hidden bg-white">
                  <Image
                ...
                <div className="w-full flex flex-col ml-8 py-4 justify-between">
                  ...
                  <Link href={project.repo}>
                    <a target="_blank" rel="noreferrer" className="flex justify-end ">
